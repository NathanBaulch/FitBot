...
namespace FitBot.Test.Services
{
    ...
    public class WorkoutPullServiceTests
    {
        ...
        public async Task Empty_Test()
        {
            ...
            var workouts = await new WorkoutPullService(database.Object, fitocracy.Object, activityGrouping.Object, activityHasher.Object).Pull(new User {InsertDate = DateTime.UtcNow});

            Assert.That(workouts, Is.Empty);
        }

        [Test]
        public async Task Single_Unchanged_Test()
        {
        ...
        [Test]
        public async Task Single_Update_Shallow_Test()
        {
            var database = new Mock<IDatabaseService>();
        ...
        [Test]
        public async Task Single_Update_Deep_Test()
        {
            var database = new Mock<IDatabaseService>();
        ...
        [Test]
        public async Task Single_Delete_Test()
        {
        ...
        [Test]
        public async Task Delete_Old_Test()
        {
            var database = new Mock<IDatabaseService>();
        ...
        [Test]
        public async Task Half_Unchanged_Page_Test()
        {
        ...
        [Test]
        public async Task Initial_Changed_Test()
        {
            var database = new Mock<IDatabaseService>();
            var workout1 = new Workout {Id = 1, Date = new DateTime(2014, 1, 1), Points = 1, Activities = Array.Empty<Activity>()};
            database.Setup(x => x.GetWorkouts(0, new DateTime(2014, 1, 1), DateTime.MaxValue)).ReturnsAsync(new[] {workout1});
        ...
        [Test]
        public async Task Dates_Out_Of_Sequence_Across_Pages_Test()
        {
            var workout2 = new Workout {Id = 2, Date = new DateTime(2014, 1, 2), Activities = Array.Empty<Activity>()};
            var workout1 = new Workout {Id = 1, Date = new DateTime(2014, 1, 1), Activities = Array.Empty<Activity>()};
