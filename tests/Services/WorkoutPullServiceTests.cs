...
namespace FitBot.Test.Services
{
    ...
    public class WorkoutPullServiceTests
    {
        ...
        public void Empty_Test()
        {
            ...
            var workouts = new WorkoutPullService(database.Object, fitocracy.Object, activityGrouping.Object, activityHasher.Object).Pull(new User {InsertDate = DateTime.UtcNow}).Result;
