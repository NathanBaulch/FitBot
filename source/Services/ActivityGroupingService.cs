...
namespace FitBot.Services
{
    public class ActivityGroupingService : IActivityGroupingService
    {
        private readonly IDictionary<string, Group> _groups = new[]
                {
                    ...
                    Builder.Bodyweight("Bird Dog/Dead Bug").Include("bird dog", "bird-dog", "dead bug"),
                    Builder.Bodyweight("Blackbird").Include("blackbird"),
                    Builder.Bodyweight("Body Weight Squat").Include("body weight squat", "body weight * squat", "raptor squat", "sissy squat", "squat progression", "jump squat", "squat to stand", "let me ins").Exclude("lunge"),
                    Builder.Bodyweight("Bridge").Include("bridge"),
                    Builder.Bodyweight("Burpee").Include("burpee"),
                    Builder.Bodyweight("Crawl").Include("crawl"),
                    ...
                    Builder.Bodyweight("Hamstring Raise").Include("hamstring raise"),
                    ...
                    Builder.Bodyweight("Hip Hinge").Include("hip hinge").Exclude("row"),
                    ...
                    Builder.Bodyweight("Leg Raise").Include("leg raise", "knee raise", "frog raise", "toes-to-bar", "knees-to-elbows"),
                    ...
                    Builder.Bodyweight("Walkout").Include("walkout").Exclude("push-up"),
                    Builder.Bodyweight("Wall Slide").Include("wall slide"),
                    ...
                    Builder.Cardio("Running").Include("running", "jogging", "hashing").Exclude("stairs"),
                    ...
                    Builder.Sports("Martial Arts").Include("aikido", "brazilian jiu-jitsu", "capoeira", "chin na", "eskrima", "hapkido", "iaido", "jiu-jitsu", "judo", "karate", "kempo", "kendo", "kickboxing", "krav maga", "kung fu", "martial arts", "muay thai", "ninjutsu", "qigong", "savate", "shuai jiao", "taekwondo", "tai chi", "viet vo dao", "wing chun"),
                    ...
                    Builder.Sports("Plank").Include("plank", "push-up hold").Exclude("abduction", "jacks", "lifts", "hip extension"),
                    ...
                    Builder.Sports("Sitting").Include("sitting"),
                    ...
                    Builder.Sports("Yoga").Include("yoga", "ashtanga", "hatha", "pilates", "vinyasa").Exclude("push-up"),
                    ...
                    Builder.Weights("Bicep Curl").Include("bicep curl", "biceps curl", "curls * squat rack", "dumbbell curl", "hammer curl", "barbell curl", "preacher curl", "concentration curl", "cable curl", "bar curl", "reverse curl", "incline curl", "spider curl"),
                    ...
                    Builder.Weights("Sled").Include("sled").Exclude("sledgehammer"),
                    Builder.Weights("Sledgehammer").Include("sledgehammer"),
                    Builder.Weights("Snatch").Include("snatch").Exclude("deadlift"),
                    Builder.Weights("Squat").Include("squat", "pistol", "full zercher").Exclude("body weight", "curl", "progression", "raptor", "sissy", "jump", "to stand", "stretch"),
        ...
        public ActivityCategory? GetGroupCategory(string groupName) => _groups.TryGetValue(groupName, out var group) ? group.Category : null;
        ...
        private class Builder
        {
            ...
            public static Builder Cardio(string name) => new(ActivityCategory.Cardio, name);

            public static Builder Bodyweight(string name) => new(ActivityCategory.Bodyweight, name);

            public static Builder Weights(string name) => new(ActivityCategory.Weights, name);

            public static Builder Sports(string name) => new(ActivityCategory.Sports, name);
            ...
            public Group Build() => new(_category, _name, _includeStrings, _excludeStrings);
        }
        ...
        private class Group
        {
            ...
            public Group(ActivityCategory category, string name, IList<string> includeStrings, IList<string> excludeStrings)
            {
                ...
                _excludeStrings = excludeStrings ?? Array.Empty<string>();
            }
            ...
            public bool Includes(string activityName) => Matches(activityName, _includeStrings) && !Matches(activityName, _excludeStrings);

            private static bool Matches(string name, IEnumerable<string> strings) =>
                strings.Any(str => str.Contains("*")
                    ? Regex.IsMatch(name, str.Replace("*", ".*"), RegexOptions.IgnoreCase)
                    : name.Contains(str, StringComparison.OrdinalIgnoreCase));
        }
